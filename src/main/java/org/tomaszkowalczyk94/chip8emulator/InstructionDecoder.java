...
public class InstructionDecoder {
    ...
    public AbstractInstruction decode(XBit16 instruction) {
        byte first4Bits = getFirst4Bits(instruction);
    ...
    private AbstractInstruction decode7address(XBit16 instruction) {
        ...
        byte last4Bits = getLast4Bits(instruction);
    ...
    private AbstractInstruction decodeEaddress(XBit16 instruction) {
        short lowByte = instruction.getLowByte().getUnsignedValue();
        switch (lowByte) {
            case 0x9E:
                return new SkpVx();
            case 0xA1:
    ...
    private byte getFirst4Bits(XBit16 instruction) {
    ...
    private byte getLast4Bits(XBit16 instruction) {
        XBit8 ret = XBit8.valueOfBooleanArray(new boolean[]{
                false, false, false, false,
