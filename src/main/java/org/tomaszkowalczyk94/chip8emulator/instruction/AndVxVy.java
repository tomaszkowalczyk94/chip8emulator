...
public class AndVxVy extends AbstractInstruction {
    public void execute(XBit16 instruction, Cpu cpu) {
        ...
        cpu.getRegisters().generalPurpose[x] = (byte) (cpu.getRegisters().generalPurpose[x] & cpu.getRegisters().generalPurpose[y]);
